...
public interface JoggingRepository extends PagingAndSortingRepository<Jogging, Long>, JpaSpecificationExecutor<Jogging> {
...
//    @Query(nativeQuery = true, value = "Select From Jogging where j.email = :email")
    ...
    // Page<Jogging> findByUserEmail(Specification<Jogging> specification, @Param("email") final String email, Pageable
    // pageReguest);
    ...
    @Override
    Page<Jogging> findAll(Specification<Jogging> specification, Pageable pageable);
